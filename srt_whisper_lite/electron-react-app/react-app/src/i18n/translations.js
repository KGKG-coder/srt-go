...
export const translations = {
  'zh-TW': {
    ...
    settings: {
      ...
      languageFixed: '安裝時固定',
      languageFixedDescription: '介面語言已在安裝時設定，無法更改。',
      tip: '提示',
  ...
  'zh-CN': {
    ...
    settings: {
      title: '设置',
      languageFixed: '安装时固定',
      languageFixedDescription: '界面语言已在安装时设定，无法更改。',
      model: '模型',
      language: '语言',
      outputFormat: '输出格式',
      outputFolder: '输出文件夹',
  ...
  'en': {
    ...
    app: {
      title: 'SRT GO',
      subtitle: 'AI Subtitle Generation Tool',
      appTitle: 'SRT GO - AI Subtitle Generator',
      selectFiles: 'Select Files',
      startProcessing: 'Start Subtitle Generation',
    ...
    settings: {
      title: 'Settings',
      languageFixed: 'Fixed at Installation',
      languageFixedDescription: 'Interface language was set during installation and cannot be changed.',
      model: 'Model',
      language: 'Language',
  ...
  'ja': {
    ...
    settings: {
      title: '設定',
      languageFixed: 'インストール時に固定',
      languageFixedDescription: 'インターフェース言語はインストール時に設定されており、変更できません。',
      model: 'モデル',
      language: '言語',
      outputFormat: '出力フォーマット',
      outputFolder: '出力フォルダ',
      enableGPU: 'GPU アクセラレーションを有効化',
      enableVAD: '音声検出を有効化'
    },
    ...
    settings: {
      ...
      languageFixed: 'インストール時に固定',
      languageFixedDescription: 'インターフェース言語はインストール時に設定され、変更できません。',
      tip: 'ヒント',
  ...
  'ko': {
    ...
    app: {
      ...
      appTitle: 'SRT GO - AI 자막 생성기',
      selectFiles: '파일 선택',
      startProcessing: '자막 생성 시작',
      pauseProcessing: '처리 일시정지',
    ...
    settings: {
      title: '설정',
      languageFixed: '설치 시 고정',
      languageFixedDescription: '인터페이스 언어는 설치 시에 설정되었으며 변경할 수 없습니다.',
      model: '모델',
      language: '언어',
      outputFormat: '출력 형식',
      outputFolder: '출력 폴더',
      enableGPU: 'GPU 가속 활성화',
      enableVAD: '음성 감지 활성화'
    },
    ...
    settings: {
      ...
      languageFixed: '설치 시 고정됨',
      languageFixedDescription: '인터페이스 언어가 설치 시 설정되어 변경할 수 없습니다.',
      tip: '팁',
